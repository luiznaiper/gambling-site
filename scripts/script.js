...
const data = {
    "What is online gaming?": "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
    "Is it safe to gamble online?": "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
    "What are the best online gambling sites?": "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
    "Is online gambling legal in USA?": "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
    "Can I play online casino games for free?": "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
    "Can I gamble for real money online?": "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
    "How popular is online gambling?": "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
    "Can I gamble on my mobile device?": "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
};
...
window.addEventListener("load", () => {
    ...
    for (let question in data) {
        appendFaq(question, data[question]);
    }
});
...
function appendFaq(question, answer) {
    ...
    titleAndButtonContainer.className = "title-and-button-container w-100 d-flex overflow-hidden position-relative";

    /* Creating the "div" containing the question text */
    const textTitleContainer = document.createElement("div");
    textTitleContainer.className = "col-9 d-flex h-100 align-items-center justify-content-start";
    ...
    imageContainer.className = "col-3 d-flex h-100 align-items-center justify-content-end";

    /* Creating the image "button" */
    const image = document.createElement("img");
    image.src = "./assets/mover-al-siguiente.png";
